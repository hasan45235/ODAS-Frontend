...
const FAQs = (props) => {
    ...
    <>
      ...
      {expandState[num] && <Box sx={{display:"flex",borderRadius:2,justifyContent:"center",alignItems:"center",flexDirection:"column",width:"80%",p:2,border:"1px solid #f5f0f0ff",transition:"height 3s",mb:2,mt:0}}>
